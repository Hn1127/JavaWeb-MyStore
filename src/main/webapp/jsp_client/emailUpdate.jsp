...
<script>
	function checkInput(event) {
		var oldPassword = document.getElementById("oldEmail");
		var newPassword = document.getElementById("newEmail");
...
<body class="main" style="background-color:;">
	...
	<div style="width: 60%; margin: auto; min-height: 67.5%;">
		<form action="/emailUpdateSuccess" method="post">
			<div>
				<table class="userInfo"
					style="margin: auto; border-collapse: separate; border-spacing: 10px 15px;" border="0">
					<tr>
						<td style="text-align: right;width:30%;">新邮箱:</td>
						<td style="text-align: left;"><input type="text"
							id="newEmail" name="newEmail" style="width:250px"></td>
